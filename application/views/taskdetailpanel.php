...
<tr class="<?php echo $result[0]['container'] ?>" id="<?php echo $result[0]['container'] ?>" >
  <td colspan="22">
    <div id="rowtabs">
      ...
      <div class="tab-content scrollbar" id="style-2" style="display:block; height: 150px;">
        <?php if ($r['category']) { ?>
        <?php
        $i = 1;
        foreach ($r['category'] As $ltabname) {
        ...
        <div id="home<?php echo preg_replace('/[^A-Za-z0-9\-]/', '', $ltabname['category']); ?>" class="tab-pane fade in <?php echo ($i == 1) ? 'active' : ''; ?>">     
          <table class="table table-hover">
            <tbody>
              <?php if (count($ltabname['labels'])>0){ foreach ($ltabname['labels'] as $l) {  ?>
              <tr>
                <td>
             ...
             <?php }  }else{ ?>  <p class="alert alert-q alert-dismissible fade in">
    ...
    Details not available.
        ...
        <div id="menu3<?php echo $k ?>" class="tab-pane fade">
          <table class="table table-hover">
            ...
            <tbody>
              <?php if(count($r['assets'])>0){ foreach ($r['assets'] As $asst) { ?> 
              <tr>
                <td>
              ...
              <?php } }else{?> <p style="color:red; font-size: 15px;">No asset lable found <?php } ?>  </p>
            </tbody>
          </table>
        </div>
        <?php } ?>
        ...
        <div id="menu4<?php echo $k ?>" class="tab-pane fade">
          <table class="table" cellpadding="20" cellspacing="60">
            <tbody>
              <tr>                                                       
                <td>
                  <?php if(count($r["document"])>0){ foreach ($r["document"] as $v) { ?>
                  <div class="placehold">
                 ...
                 <?php } }else{?> <p style="color:red; font-size: 15px;">No record found <?php } ?>  </p>
                </td>                                                     
              </tr>
            </tbody>
          </table>
        ...
        <div id="menu5<?php echo $k ?>" class="tab-pane fade">
          <table class="table">
            <tbody>
              <?php if(count($r['complete'])>0){ foreach ($r["complete"] as $v) { ?>
              <tr>
              ...
              <tr>
                ...
                <?php } }else{?> <p style="color:red; font-size: 15px;">No complete data found <?php } ?>  </p>
            </tbody>
          </table>
        </div>
        <?php } ?>

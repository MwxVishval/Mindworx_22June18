        ...
        <table id="datatable" class="table table-striped table-bordered tasklists ">
            ...
            <tbody>
                ...
                foreach ($result AS $r) {
                    ?>
                    <?php //var_dump ($result); ?>
                <tr class="row_show_<?php echo $k ?>"  id="row_show_<?php echo $k ?>"  onclick="taskdetail(this,'row_show_<?php echo $k ?>','<?php echo $r['id']; ?>','<?php echo $i; ?>','<?php echo $r['task_type_id']; ?>')">
                        <td><?php echo $i++ ?></td>
